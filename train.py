...
def train(opt):
    ...
    while iter < opt.num_iters:
        ...
        q_values.append(torch.max(current_prediction_batch).item())
    ...
    plt.figure(figsize=(10, 5))
    plt.plot(epsilons, label='Epsilon over Iterations')
    plt.xlabel('Iteration')
    plt.ylabel('Epsilon')
    ...
    plt.figure(figsize=(10, 5))
    plt.plot(rewards_collected, label='Rewards over Iterations')
    plt.xlabel('Iteration')
    plt.ylabel('Reward')
    plt.title('Rewards Received Over Iterations')
    plt.legend()
    plt.savefig('rewards_over_time.png')
    plt.show()

    plt.figure(figsize=(10, 5))
    plt.plot(q_values, label='Max Q-Value over Iterations')
    plt.xlabel('Iteration')
    plt.ylabel('Max Q-Value')
    plt.title('Development of Q-Values Over Time')
    plt.legend()
